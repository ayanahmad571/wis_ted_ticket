    ...
    <body>
        ...
        <section class="content">
            ...
            <?php
			 ...
			 $usertypeid =$_SESSION['STWL_LUM_TU_ID'] ; ?>
            <!-- ================== -->
<?php
switch ($usertypeid) {
    case "1":
...
where p.adv_valid =1 and p.adv_rel_lum_id = ".$_SESSION['TICKET_LUM_DB_ID']." and s.st_valid = 1 and s.st_rel_lum_id= ".$_SESSION['TICKET_LUM_DB_ID']." order by adv_dnt desc";
$getmunsres= $conn->query($getmunssql);
if ($getmunsres->num_rows > 0) {
    // output data of each row
	$rrt = 1;
