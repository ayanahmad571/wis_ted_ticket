...
<link href="assets/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />  
                    ...
                    <div class="col-lg-12	">
                        ...
                        <div class="panel panel-default"><!-- /primary heading -->
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Initial Ticket Request (ITR)</h3>
                            </div>
 ...
 position:relative;" class="row">
	...
	where tur_valid =1 and tur_approved = 0
...
if ($productres->num_rows > 0) {
	...
	while($productrw = $productres->fetch_assoc()) {
		...
		echo '<tr>
	<td>'.$con.'</td>
	<td>'.substr($productrw['tur_fname'],0,1).md5(md5(sha1(sha1(md5($productrw['tur_id'].$productrw['tur_dnt']))))).substr($productrw['tur_lname'],0,1).'</td>
	...
	<td>
<button id="getQoEdit" data-toggle="modal" data-target="#view-modal" data-id="'.md5($productrw['tur_id']).'" class="btn btn-sm btn-warning">Edit</button>
<hr>

<form action="master_action.php" method="post">
<input type="hidden" name="t_u_ap_tur" value="'.md5($productrw['tur_id']).'" />
<button type="submit" class="btn btn-sm btn-success">Approve</button>
</form>
<br>
<form action="master_action.php" method="post">
<input type="hidden" name="t_u_dapr_tur" value="'.md5($productrw['tur_id']).'" />
