                    ...
                    <div class="col-lg-12	">
                        ...
                        <div class="panel panel-default"><!-- /primary heading -->
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title">Ticket Validator</h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div align="center" class="col-md-12 col-sm-12 col-xs-12">
                                                <button class="btn btn-danger btn-lg" style="width:60%; height:125px" onclick="getScan()">Scan</button>
                                                  <h1 id="classappend">
                                                	
                                                </h1>
                                                            <script type="text/javascript">
																function processBarcode(b){
    $.post("test_sockets.php",
    {
      check: b
    },
    function(data,status){
      $("#classappend").html(data);
    });
