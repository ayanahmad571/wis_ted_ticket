...
<form action="master_action.php" method="post" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input name="usr_email" type="email" class="form-control" aria-describedby="emailHelp" placeholder="Enter email">
    <small id="emailHelp" class="form-text text-muted">School Email</small>
  </div>
  <div class="form-group">
    <label>First Name</label>
    <input name="usr_fname" type="text" class="form-control"  placeholder="First Name">
  </div>
  <div class="form-group">
    <label>Last Name</label>
    <input name="usr_lname" type="text" class="form-control"  placeholder="Last Name">
  </div>
  <div class="form-group">
    <label>Selfie</label>
    <input name="ch_img" type="file" class="form-control" accept="image/*" aria-describedby="1emailHelp">
